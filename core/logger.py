...
def color_text(in_text: str, color="light_red") -> str:
    return text_colors["light_red"] + in_text + text_colors["end_color"]


def highlight(in_text: str, highlight_color="light_red") -> None:
    colored_text = text_colors[highlight_color] + in_text + text_colors["end_color"]
    print(colored_text)
...
def log_section_header(header: str) -> None:
    double_dash_line()
    print(
        text_colors["info"]
        + text_colors["bold"]
